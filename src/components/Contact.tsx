      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-muted-foreground text-lg">
            Have questions? We are available 24/7 to help plan your journey.
          </p>
        </div>
        ...
        <div className="mt-12 max-w-2xl mx-auto">
          <div className="grid sm:grid-cols-3 gap-4">
            {items.map((it, i) => (
              <motion.a
                ...
                className="bg-card rounded-lg p-5 shadow-soft hover:border-gold/40 transition-colors border border-border text-center"
              >
                <div className="w-10 h-10 rounded-md bg-accent flex items-center justify-center mx-auto">
          ...
          <div className="mt-6 bg-card rounded-lg p-6 shadow-soft border border-border">
            ...
            <div className="mt-3 flex gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-md bg-secondary hover:bg-accent hover:text-gold-foreground flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-md bg-secondary hover:bg-whatsapp hover:text-white flex items-center justify-center transition-colors"
                aria-label="WhatsApp"
              >
